...
// question 5 //
{
    ...
    info: "A Directive security control can be defined as guidelines, policies, SOPs, laws, or regulations. Companies will hold training and awareness programs to keep their employees up to date on the Cyber-security best practices. A Deterrent security control may not prevent an attack but will attempt to discourage an attacker from trying. A Preventive security control helps reduce the likelihood that an attack can succeed. This is an action that will take place BEFORE an attack occurs. A Corrective security control eliminates / reduces the impact of a security violation. This will take place AFTER an attack. ",
    answers: [
...
<!—Question 16 -->
<span style="font-size: 25px;">Q16.</span> Every day at noon, you are to perform preventative maintenance on a Third-party system. You are not familiar with this system, but you know it is vital to maintaining your network. Luckily, there is a Standard Operating Procedure (SOP) that details every step of the required maintenance. What type of security control is this considered? 
<br>
<br>
A - Deterrent
<br>
