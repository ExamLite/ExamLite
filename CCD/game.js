...
const enemyTypes = {
    'enemy1': { size: 20, speed: 2.5, color: '#17202a' }, // Fastest
    'enemy2': { size: 40, speed: 2.0, color: '#222' },
    'enemy3': { size: 60, speed: 1.5, color: '#333' },
    'enemy4': { size: 80, speed: 1.0, color: '#444' }  // Slowest
};
